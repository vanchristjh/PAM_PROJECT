    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        textTheme: const TextTheme(
          bodyLarge: TextStyle(color: Colors.black87), // Fixed here
        ),
      ),
...
class _TransferDetailState extends State<TransferDetail> {
  ...
  void _performTransfer() {
    ...
    if (amount == null || amount <= 0) {
      setState(() {
        _transferMessage = "Input jumlah transfer tidak valid.";
      });
      return;
    }
    ...
    setState(() {
      if (success) {
        _transferMessage = "Transfer berhasil sebesar Rp${amount.toStringAsFixed(2)} ke ${recipientAccount.accountHolder}.";
      } else {
