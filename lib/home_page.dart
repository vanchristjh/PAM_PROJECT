...
import 'package:saku_digital/pages/transaction_detail.dart';  // Import TransactionDetail
import 'package:saku_digital/pages/transfer_detail.dart';
import 'package:saku_digital/pages/messages_page.dart';  // Import MessagesPage
...
class _HomePageState extends State<HomePage> {
  ...
  void _openMessages() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const MessagesPage()), // Navigate to MessagesPage
    );
  }
        ...
        title: Row(
          ...
          children: [
            ...
            Row(
              children: [
                IconButton(
                  onPressed: _openMessages,  // Navigate to MessagesPage
